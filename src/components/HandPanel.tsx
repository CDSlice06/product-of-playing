import { Ban, Landmark, Laugh, Sparkles, Swords, WandSparkles, Waves } from "lucide-react";
...
export default function HandPanel({
  ...
  return (
    <div className="space-y-4 rounded-[2rem] border border-white/10 bg-slate-950/75 p-4 shadow-[0_30px_80px_rgba(15,23,42,0.4)] backdrop-blur-xl">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.35em] text-slate-500">Tarot Hand</p>
          <h3 className="mt-1 font-display text-2xl text-slate-50">塔罗牌库</h3>
        </div>
